...
int main(int argc, char const *argv[])
{
	...
	const char *inFilename = "rtsp://admin:HQ123456789@192.168.4.12:554";
	// const char *outFilename = "rtsp://192.168.4.7:8554/test"; //输出URL
	const char *outFilename = "rtsp://192.168.4.26:554/bitmain"; //输出URL
	const char *ofmtName = NULL;

	// av_register_all();
	avformat_network_init();

	// AVInputFormat *ifmt = av_find_input_format(inFilename);
	// if (!ifmt)
	// {
	...
	if ((ret = avformat_open_input(&ifmtCtx, inFilename, nullptr, &options)) < 0)
	{
